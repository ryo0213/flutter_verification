      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('・asyncとawaitキーワードを利用し、時間が掛かる関数の値処理が終わった際に次の処理実施'),
            ElevatedButton(
              onPressed: () async{
              ...
              child: const Text('非同期処理：asyncとawaitキーワードを利用'),
            ),

            Text('・asyncとawaitキーワードを利用し、時間が掛かる関数の値処理が終わる前に次の処理実施'),
            ElevatedButton(
              onPressed: () {
                FutureExample.asyncExe();
                print('next....');
              },
              child: const Text('非同期処理：asyncとawaitキーワードを利用'),
            ),
